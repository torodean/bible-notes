...
\begin{quotation}
``If just one percent of the weight of mantle rock located in the transition zone is \ce{H2O}, that would be equivalent to nearly \textit{three} times the amount of water in our oceans, the researchers said \cite{deep earth water}.''
\end{quotation}
