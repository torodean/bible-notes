...
There are two distinct prevailing thoughts I've regularly heard about this topic. The first is that we have far too many \textit{doom and gloom} messages. In contrast, the second is that we have \textit{not} and we could actually use some more.
