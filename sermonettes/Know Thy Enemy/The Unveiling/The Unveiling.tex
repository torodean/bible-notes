...
\begin{quotation}
And have no fellowship with the unfruitful works of darkness, but rather expose them. For it is shameful even to speak of those things\footnote{In English, this may seem like you are not suppose to `speak of those things', which somewhat contradicts `exposing them.' This is actually saying the things \textit{they} do are so shameful, that to even speak of doing them is shameful.} which are done by them in secret. - Ephesians 5:11-12
\end{quotation}
