...
The details in the proceeding chapters are designed to be concise while also being as thorough as \textit{potentially} needed for someone who has never done the sound setup before. Ideally, someone needing to do the sound setup will have either already done it before, or be learning to do so. This guide is designed to (hopefully) be helpful in both of those scenarios.

\section{Setting Up The Stage}

See Figures \ref{fig:podium} and \ref{fig:mic_box} for reference on the stage setup.

\begin{enumerate}[noitemsep, topsep=0pt]
	\item Bring one of the spare tables to the stage. Place the table in the center of the stage so that the long edge is parallel with the stairs of the stage.
	...
	\item Setup a microphone stand. 
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Make sure the stand has all of the clips tightened snugly. If there are any loose parts, the stand may shrug or fall slowly during services.
			...
			\end{note}
		\end{enumerate}
	\item Place two bottles of water on the table behind the podium for the speakers (if they need them during their messages).
\end{enumerate}

\section{Setting Up The Camera}

See Figures \ref{fig:camera} and \ref{fig:zoom_window} for reference on setting up the camera.
...
See Figures \ref{fig:laptop_connections} and \ref{fig:soundboard_power} for reference on setting up the laptop.
...
See Figure \ref{fig:projector_control} for reference when setting up the projector.
...
See Figure \ref{fig:capture_card} for reference when setting up the capture card.
...
See Figure \ref{fig:zoom_window} for reference when setting up zoom.
...
See Figure \ref{fig:vlc_window} for reference when setting up the hymns.
...
See Figure \ref{fig:vlc_window} for reference when setting up the special music.
