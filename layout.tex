...
\newcommand{\historicalnote}[2]{%
	\global\notesafterversetrue%
	\par\noindent%
	\hspace*{2em}\begin{minipage}{\dimexpr\linewidth - 2em\relax}%
...
% The word was is often added when translating to English. This is always ittalicized, so this command is just to save time.
