...
\bookchapter{\name{Noah}’s Deliverance}

\bverse Then God remembered \name{Noah}, and every living thing, and all the animals that \were with him in the ark\index{Ark}. And God made a wind to pass over the earth\index{Earth}, and the waters\index{Water} subsided.
...
\bverse So it came to pass, at the end of the forty days, that \name{Noah} opened the window of the ark\index{Ark} which he had made.
...
\bverse But the dove found no resting place for the sole of her foot, and she returned into the ark\index{Ark} to him, for the waters\index{Water} \were on the face of the whole earth\index{Earth}. So he put out his hand and took her, and drew her into the ark\index{Ark} himself.
\bverse And he waited yet another seven days, and again he sent the dove out from the ark\index{Ark}.
\bverse Then the dove came to him in the evening, and behold, a freshly plucked olive leaf\vmark{a} \was in her mouth; and \name{Noah} knew that the waters\index{Water} had receded from the earth\index{Earth}.
...
\bverse And it came to pass in the six hundred and first year, in the first \textit{month}, the first \textit{day} of the month\vmark{a}, that the waters\index{Water} were dried up from the earth\index{Earth}; and \name{Noah} removed the covering of the ark\index{Ark} and looked, and indeed the surface of the ground was dry.
	\contextnote{a}{This time is a reference to \name{Noah}'s years on the earth\index{Earth}. When the flood happened, he was 600 years old (see figure \ref{fig:adams_genealogy} and \bref{Genesis 7:6}).}
...
\bverse So \name{Noah} went out, and his sons and his wife and his sons' wives with him.
...
\bverse Then \name{Noah} built an altar\index{Altar} to the \lord, and took of every clean animal and of every clean bird, and offered burnt offerings on the altar\index{Altar}.
	\contextnote{}{This is the first time a \textit{burnt offering} is explicitly mentioned in scripture. It is possible that \name{Abel}'s offering in \bref{Genesis 4:4}, though it does not state explicitly that it is a \text{burnt} offering. The laws\index{Law} around offerings have not yet been elaborated on or explained.}	
