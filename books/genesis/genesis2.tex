...
\bverse This \textit{is} the history of the heavens\index{Heaven} and the earth\index{Earth} when they were created, in the day that the \lordvmark{a} God made the earth\index{Earth} and the heavens\index{Heaven},
	\translationnote{a}{This is the \textit{Tetragrammaton}\index{Tetragrammaton}, which is the four-letter proper Hebrew\index{Hebrew} name of God, \textit{YHWH}. This is the first time it appears. It means `the existing One' (Strong's Concordance 3068 \cite{Strong's GodRules})}
...
\bverse Now a river went out of Eden\index{Eden} to water\index{Water} the garden, and from there it parted and became four river-heads.
...
\bverse The name of the second river \textit{is} Gihon\index{Gihon}\vmark{a}; it \textit{is} the one which goes around the whole land of \name{Cush}.
...
\bverse Then\vmark{a} the \lord God took the man and put him in the garden of Eden\index{Eden} to tend and keep it\vmark{b}.
	\literarynote{a}{This verse seems somewhat redundant when considered alongside \bref{Genesis 2:8}. The structure of the text reflects a Hebrew\index{Hebrew} narrative style and this verse serves to emphasize that God is assigning \name{Adam} responsibilities and not just placing him in the garden.}
	\generalnote{b}{God placed man in the garden to \textit{work}. This is something intended for man to do. \textit{Tending} the garden also implies taking care of it and not abusing it. This is the intent of our human-nature relationship.}
...
\bverse but of the tree\index{Tree} of the knowledge of good and evil you shall not eat, for in the day that you eat\vmark{a} of it you shall surely die\vmark{b}.''
	...
	\translationnote{b}{As written in English, the phrase ``you shall surely die'' seems to suggest that \name{Adam} would die within the day or nearly immediately. However, some would say this can be better translated as ``dying, you shall die,''\cite{Mortenson You Shall Surely Die} or ``In dying you will die,'' which would suggest this would only be the start of the process of dying.}
...
\bverse Out of the ground the \lord God formed every beast of the field and every bird of the air, and brought \textit{them} to \name{Adam} to see what he would call them. And whatever \name{Adam} called each living creature, that \was its name.
	\literarynote{}{Some see this and the surrounding scriptures as a contradiction to the creation in \bref{Genesis 1}. However, there is no time references in this scripture. This is clearly following a literary style of expanding on other events that have already been described. This is more obviously seen in some later scriptures such as \bref{Genesis 2:15} and \bref{Genesis 2:20}, which is pivotal to understanding that these are \textit{not} contradicting accounts - but rather building and expanding on each other.}

\bverse So \name{Adam} gave names to all cattle, to the birds of the air, and to every beast of the field. But for \name{Adam} there was not found a helper comparable to him\vmark{a}.
...
\bverse And the \lord God caused a deep sleep to fall on \name{Adam}, and he slept; and He took one of his ribs, and closed up the flesh in its place.
...
\end{bquotation}
\bverse Therefore a man shall leave his father and mother and be joined to his wife, and they shall become one flesh\vmark{a}.
	\contextnote{a}{This is the creation of marriage.}
