...
\bverse In the beginning God\vmark{a} created the heavens\index{Heaven} and the earth\index{Earth}\vmark{b}.
	...
	\translationnote{b}{The word \textit{earth} is often not capitalized when translated from scriptures in versions like the NKJV. This is because it is not the proper noun referring to Earth, but that of matter, dirt, ground, or the physical qualities which are on Earth.}
