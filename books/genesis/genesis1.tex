...
\bverse{Then God said, ``Let the earth bring forth the living creature according to its kind: cattle and creeping thing and beast of the earth, \textit{each} according to its kind\vmark{a}''; and it was so.}
...
\bverse{And God made the beast of the earth according to its kind, cattle according to its kind, and everything that creeps on the earth according to its kind. And God saw that \textit{it was} good.}
\bverse{Then God said, ``Let Us\vmark{a} make man in Our\vmark{b} image, according to Our likeness; let them have dominion over the fish of the sea, over the birds of the air, and over the cattle, over all the earth and over every creeping thing that creeps on the earth.''}
...
\bverse{And God said, ``See, I have given you every herb \textit{that} yields seed which \textit{is} on the face of all the earth, and every tree whos fruit yields seed; to you it shall be for food.}
	\generalnote{}{Here we see that every herb and fruit tree with seeds is explicitly created as a food source.}
