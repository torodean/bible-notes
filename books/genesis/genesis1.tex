...
\bverse In the beginning God\vmark{a} created the heavens\index{Heaven} and the earth\index{Earth}\vmark{b}.
	\translationnote{a}{The word used here is `Elohim' (Strong's 430\cite{Strong's GodRules, Hebrew Concordance}) which is plural and means `God, gods, divine beings, or judges.' This same word is used throughout this entire chapter.}
	\translationnote{b}{The word \textit{earth}\index{Earth} is often not capitalized when translated from scriptures in versions like the NKJV. This is because it is not the proper noun referring to Earth\index{Earth}, but that of matter, dirt, ground, or the physical qualities which are on Earth\index{Earth}.}
	\sciencenote{}{``In the beginning'' implies that there was a beginning. ``The heavens\index{Heaven}'' could refer to the entire cosmos or even space itself. ``The earth\index{Earth}'' could refer to the entirety of matter within the universe or simply bring the focus to earth\index{Earth} (while not explicitly excluding anything outside of earth\index{Earth}).}
...
\bverse The earth\index{Earth} was\vmark{a} without form, and void; and darkness \was on the face of the deep. And the Spirit of God was hovering over the face of the waters\index{Water}\vmark{b}.
...
\bverse Thus God made the firmament, and divided the waters\index{Water} which \were under the firmament\vmark{a} from the waters\index{Water} which \were above the firmament\vmark{b}; and it was so.
...
\bverse And the earth\index{Earth} brought forth grass\vmark{a}, the herb \that yields seed according to its kind\vmark{b}, and the tree\index{Tree} \that yields fruit, whos seed \textit{is} in itself according to its kind. And God saw that \textit{it was} good.
...
\bverse Then God blessed them, and God said to them, ``Be fruitful and multiply\vmark{a}; fill the earth\index{Earth} and subdue it; have dominion over the fish of the sea, over the birds of the air, and over every living thing that moves on the earth\index{Earth}.''
	\doctrinenote{a}{Although this doesn't seem like a direct \textit{commandment}, it is repeated throughout the Bible as something that God tells men to do - specifically men who follow after God. It is clear that God wants those following His words to be fruitful and multiply their generations.}

\bverse And God said, ``See, I have given you every herb \that yields seed which \textit{is} on the face of all the earth\index{Earth}, and every tree\index{Tree} whos fruit yields seed; to you it shall be for food.
